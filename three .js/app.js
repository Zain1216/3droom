...
function createRoom(widthFeet, heightFeet) {
    ...
    // Example: Add a window to the back wall centered
    ...
    // Example: Add a door to the front wall centered
    const doorWidth = 0.7;
...
function updateRoomSize() {
    ...
    let totalWidth = 0;
    const spacing = 0.5; // increased spacing between rooms
    if (width1) totalWidth += width1 / 12 + spacing;
    if ((bedroomCategory === '2bed' || bedroomCategory === '3bed' || bedroomCategory === '4bed') && width2) totalWidth += width2 / 12 + spacing;
    if ((bedroomCategory === '3bed' || bedroomCategory === '4bed') && width3) totalWidth += width3 / 12 + spacing;
    if (bedroomCategory === '4bed' && width4) totalWidth += width4 / 12 + spacing;
